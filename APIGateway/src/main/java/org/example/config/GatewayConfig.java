...
public class GatewayConfig {
    ...
    public RouteLocator customRouteLocator(RouteLocatorBuilder builder) {
        return builder.routes()
                ...
                .route("file-generation-route", r -> r.path("/fileGeneration/**").uri("lb://file-generation"))
                ...
                .route("ticket-management-route", r -> r.path("/ticketManagement/**").uri("lb://ticket-management"))
